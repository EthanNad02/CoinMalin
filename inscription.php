...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        // ✅ On initialise last_password_change à NOW() pour que le cooldown parte de zéro
        $sql = "INSERT INTO utilisateurs (nom, prenom, email, mot_de_passe, telephone, last_password_change, password_history)
                VALUES ('$nom', '$prenom', '$email', '$mot_de_passe_hash', '$telephone', NOW(), NULL)";
